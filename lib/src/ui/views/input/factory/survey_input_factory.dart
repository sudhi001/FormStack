...
class SurveyInputWidget {
  ...
  static HiddenInputWidgetView hidden(
    QuestionStep questionStep,
    FormStackForm formStackForm,
    String? text,
    String? title,
  ) {
    return HiddenInputWidgetView(
      formStackForm,
      questionStep,
      text,
      title: title,
  ...
  static CalculateInputWidgetView calculate(
    ...
    return CalculateInputWidgetView(
      formStackForm,
      questionStep,
      text,
      title: title,
